...
def main() -> None:
    ...
    controller=TelegramPaperController(PaperOrderService(broker, RiskManager(RiskSettings(), account.equity), paper_enabled=True), settings.allowed_user_ids, store=UserStore())
